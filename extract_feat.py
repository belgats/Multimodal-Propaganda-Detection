...
class CustomMMDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img =  Image.open(os.path.join(self.data_dir, obj["img_path"])).convert("RGB")#read_image(os.path.join(self.data_dir, obj["img_path"]), ImageReadMode.RGB)
...
if __name__ == '__main__':
    ...
    img_model = convnext_tiny(pretrained=True)
